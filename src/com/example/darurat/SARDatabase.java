...
public class SARDatabase extends SQLiteOpenHelper{
	private static final int DATABASE_VERSION = 1;
	
	private static final String DATABASE_NAME = "SARDB";
	...
	public SARDatabase(Context context) {
	...
	String getNoTelp(double curlat, double curlong) 
	{
		...
		for(int i = 0;i < count; i++){
			...
			if (cursor.getString(1).equals("SAR")){
